...
{
	add_action('init', 'avia_woocommerce_register_backend_assets');
}
...
function avia_woocommerce_register_backend_assets()
{
	wp_enqueue_script( 'avia-woocommerce-backend-js', AVIA_BASE_URL.'woocommerce-config/woocommerce-backend.js', array('jquery'), 1, true);
}
