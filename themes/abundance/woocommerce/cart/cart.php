...
<?php if(isset($_GET['remove_this_option'])) {
$result = $woocommerce->cart->remove_option($_GET['remove_this_option'],$_GET['the_item'], $_GET['total']); 
if($result){ echo "<script type='text/javascript'>window.location= '".$woocommerce->cart->get_cart_url()."';</script>";}
} ?>
					...
					<tr class = "<?php echo esc_attr( apply_filters('woocommerce_cart_table_item_class', 'cart_table_item', $values, $cart_item_key ) ); ?>">
						...
						<td class="product-name">
							<?php 
								...
								// Meta data
								echo $woocommerce->cart->get_item_data( $values,$cart_item_key );
